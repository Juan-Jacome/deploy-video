...
class CarrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carro" do
    assert_difference('Carro.count') do
      post carros_url, params: { carro: { color: @carro.color, marca: @carro.marca, modelo: @carro.modelo, precio: @carro.precio } }
    end
  ...
  test "should update carro" do
    patch carro_url(@carro), params: { carro: { color: @carro.color, marca: @carro.marca, modelo: @carro.modelo, precio: @carro.precio } }
